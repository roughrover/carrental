...
<form   method="POST" enctype="multipart/form-data">
    <div style="margin:50px;">
         <br><h2  align="center" > <b>Search your nearby Rental Shops</b></h2><br>
    <input id="pac-input" class="controls" type="text" placeholder="Search your location">
                ...
                <input type="text" id="l2" style="visibility: hidden;" required name="l2"><br><br>
</div>
</form>
...
if(isset($_REQUEST['submit']))
{
    $lat=$_REQUEST['l1'];
    $lon=$_REQUEST['l2'];
    $lat1= floatval($lat)+0.05;
    $lat2= floatval($lat)-0.05;
    $lon1= floatval($lon)+0.05;
    $lon2= floatval($lon)-0.05;
    $_SESSION['lat']=$lat;
    $_SESSION['lon']=$lon;
    echo '<center><table class="table table-secondary table-striped table-hover" style="margin-bottom:20px;"> 
        <h3 style="color:white;">Search result</h3>
            ...
            $qry="select * from rentalregister where email in(select username from login where statas='1' and usertype='rental') "
                    . " and (lat > '$lat2' and lat < '$lat1') "
                    . "and (lon > '$lon2' and lon < '$lon1')";
            ...
            echo '<tr>
                ...
                <td><a style="color: blue;" href="userviewcars.php?id='.$row['id'].'">View Cars</a></td>
            </tr>';
            }
