        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="rentalhome.php">Home </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="addcars.php">Cars</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="mybookings.php">Bookings</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Report <span class="fa fa-angle-down"></span>
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                <a class="dropdown-item" href="bookaccepted.php">Accepted</a>
                <a class="dropdown-item" href="bookEned.php">Ended</a>
                <a class="dropdown-item" href="salereport.php">Sales Report</a>
              </div>
              </li>
            <li class="nav-item">
